...
wget https://github.com/Pujianto1219/udp-zivpn/releases/download/udp-zivpn_1.4.9/udp-zivpn-linux-amd64 -O /usr/local/bin/zivpn 1> /dev/null 2> /dev/null
chmod +x /usr/local/bin/zivpn
mkdir /etc/zivpn 1> /dev/null 2> /dev/null
wget https://raw.githubusercontent.com/Pujianto1219/ZiVPN/refs/heads/main/config.json -O /etc/zivpn/config.json 1> /dev/null 2> /dev/null
